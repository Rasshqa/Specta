    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        @php
            $infoItems = [
                ...
                ['icon'=>'<svg class="inline align-middle w-[1em] h-[1em]" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M19 19H5V8h14m-3-7h-2v1H8V1H6v1H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2h-1M7 10h5v5H7z"/></svg>','label'=>'Timeline','route'=>'admin.infocenter.timelines'],
